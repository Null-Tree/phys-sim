...
g.world.add_orbiter(mainball,mainball.r +70,ball_r=3,mass=1)
g.world.add_orbiter(mainball,mainball.r +200,ball_r=3,mass=1)
g.world.add_orbiter(mainball,mainball.r +300,ball_r=3,mass=1)
g.world.add_orbiter(mainball,mainball.r +120,ball_r=5,mass=1)
g.main_loop()